...
import ru.recoilme.R;
import ru.recoilme.imageloader.ImageRequest.ImageRequestCallback;
...
public class AsyncImageView extends ImageView implements ImageRequestCallback {
    ...
    /**
     * Helper to {@link #setOptions(android.graphics.BitmapFactory.Options)} that simply sets the inDensity for
     * loaded image.
     *
     * @param inDensity
     * @see AsyncImageView#setOptions(android.graphics.BitmapFactory.Options)
     */
